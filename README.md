...
- :white_check_mark: \[[PROBLEM](http://rosalind.info/problems/long/)\] \[[SOLUTION](https://github.com/AakashSudhakar/Rosalind_Bioinformatics/blob/master/Bioinformatics_Stronghold/programs/P25_LONG.py)\] P25: Genome Assembly as Shortest Superstring (LONG)
- :large_orange_diamond: \[[PROBLEM](http://rosalind.info/problems/pmch/)\] \[[PROGRESS](https://github.com/AakashSudhakar/Rosalind_Bioinformatics/blob/master/Bioinformatics_Stronghold/programs/P26_PMCH.py)\] P26: Perfect Matchings and RNA Secondary Structures (PMCH)
